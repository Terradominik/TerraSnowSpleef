...
public class TerraSnowSpleef extends JavaPlugin {
    ...
    public void onEnable() {
                        ...
                        switch (strings[0]) {
                            ...
                            case "set":
                                if (spieler.isOp() || spieler.hasPermission("terrasnowspleef.admin")) {
                                    if (strings.length > 1) {
                                        if (strings.length < 3) {
                                            commands.set(spieler, strings[1].toLowerCase(), "");
                                        } else {
                                            commands.set(spieler, strings[1].toLowerCase(), strings[2]);
                                        }
                                    }
                                }
                                break;
        ...
        chat=new Chat("SnowSpleef",ChatColor.AQUA + "[SnowSpleef] ",": " + ChatColor.WHITE,null);
